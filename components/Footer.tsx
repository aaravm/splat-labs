      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="flex flex-col items-center justify-between gap-8 md:flex-row md:items-start">
          <div className="flex flex-col items-center gap-4 md:items-start">
            <a href="#" className="group flex items-center gap-2.5">
              <span className="flex h-9 w-9 items-center justify-center rounded-lg bg-gradient-to-br from-accent to-accent-violet text-sm font-black text-black transition-transform group-hover:scale-105">
                S
              </span>
            ...
            <p className="max-w-xs text-center text-sm leading-relaxed text-muted md:text-left">
              Live events in 4D Gaussian Splatting. Stream reality, in real
              time.
            </p>
          </div>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-white/[0.06] pt-6 sm:flex-row">
          <p className="text-xs text-muted/70">
            © 2026 SplatLabs, Inc. All rights reserved.
          </p>
          <div className="flex items-center gap-6">
            ...
            <a
              href="mailto:hello@splatlabs.dev"
              className="text-xs text-muted/70 transition-colors hover:text-foreground"
            >
              hello@splatlabs.dev
            </a>
